...
public class ExternalRecipes {
	...
	public static void registerFunOres(){
		...
		FunOresAPI.addDryingRackRecipe(new ItemStack(HFBlocks.resin_burlap), 4000, 0.2F, new ItemStack(HFBlocks.oily_burlap));
		FunOresAPI.addDryingRackRecipe(new ItemStack(HFBlocks.resin_burlap_block), 4000, 0.2F, new ItemStack(HFBlocks.oily_burlap_block));
	}
