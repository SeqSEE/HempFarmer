...
public class HFSeedsIndica extends ItemSeeds implements net.minecraftforge.common.IPlantable{


	public HFSeedsIndica(String name, Block crop, Block soil, int weight) {
		super(crop, soil);
 	...
 	private void register(HFSeedsIndica seeds, int weight) {
    ...
    public EnumActionResult onItemUse(ItemStack stack, EntityPlayer playerIn, World worldIn, BlockPos pos, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ){
        ...
        {
            worldIn.setBlockState(pos.up(), HFBlocks.indica_crop.getDefaultState());
            --stack.stackSize;
    ...
    {
        return HFBlocks.indica_crop.getDefaultState();
    }
